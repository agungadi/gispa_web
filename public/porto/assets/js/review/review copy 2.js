                ...
                function display() {
                    ...
                    for (var index = 0; index < questions.length; index++) {
                        ...
                        for (var i = 0; i < questions[index].children.length; i++) {
                            ...
                            //     // var urutan = $(this).prevAll('[name="answers0"]').length;
                            //     // tempChosen[index] = +urutan;
                        ...
                        $('input[type=radio][name=answers' + index + ']').change(function() {
                        ...
                        //     $('#files_list'+index+'').append(`<li id='{{id}}' class="files_item"><span class="jwban">File 1 :</span>
