...
/*!*********************************************************!*\
  !*** ./resources/js/bootstrap-iconpicker.bundle.min.js ***!
  \*********************************************************/
...
!function ($) {
  ...
  var Iconpicker = function Iconpicker(element, options) {
  ...
  Iconpicker.VERSION = "1.10.0", Iconpicker.ICONSET_EMPTY = {
    ...
    }) : icons = Iconpicker.ICONSET[op.iconset].icons, "" === search) op.icons = icons;else {
      var result = [];
