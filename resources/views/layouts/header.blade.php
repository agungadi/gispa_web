    ...
    <div id="judul">
        ...
        <ul class="navbar-nav mr-auto d-xl-block d-none">
            ...
            <a href="javascript:void(0);">
                ...
                <h1><img alt="Image placeholder" src="{{ asset('img/logos.png') }}" style="max-width:28px"
                        class="bg-white logoss"> GISPA</h1>
            </a>
    ...
    <div id="isi">
        ...
        <nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom">
            ...
            <div class="container-fluid">
                ...
                @endif
                @role('admin')
                    <a href="{{ url('p' . DIRECTORY_SEPARATOR . Auth::user()->username) }}" class="mr-3 text-danger"
                        target="_blank" data-toggle="tooltip" title="{{ __('messages.user.preview_blog') }}">
                ...
                <div id="brand">
                    ...
                    <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link pr-0" id="showdropdown" href="#" role="button"
                                data-toggle="dropdown" aria-haspopup="true">
                                <div class="media align-items-center">
                                    <span class="avatar avatar-sm rounded-circle">
                                        <img alt="Image placeholder" src="{{ asset('img/person.png') }}"
                                            class="bg-white">
                                    </span>
