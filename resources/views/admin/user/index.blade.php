...
@section('content')
    ...
    <div class="container-fluid mt--6">
        ...
        @include('admin.user.create_modal')
        @include('admin.user.edit_modal')
        @include('admin.user.templates.templates')
...
<script>
    ...
    <script src="{{ asset('porto/assets/js/users/users.js')}}"></script>
@endsection
